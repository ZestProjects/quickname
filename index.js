...
async function verifyUrl(url) {
	const regex = new RegExp("^(?:(?:(?:https?):)?\\/\\/)(?:\\S+(?::\\S*)?@)?(?:(?!(?:10|127)(?:\\.\\d{1,3}){3})(?!(?:169\\.254|192\\.168)(?:\\.\\d{1,3}){2})(?!172\\.(?:1[6-9]|2\\d|3[0-1])(?:\\.\\d{1,3}){2})(?:[1-9]\\d?|1\\d\\d|2[01]\\d|22[0-3])(?:\\.(?:1?\\d{1,2}|2[0-4]\\d|25[0-5])){2}(?:\\.(?:[1-9]\\d?|1\\d\\d|2[0-4]\\d|25[0-4]))|\\[(((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:){6,6}[0-9a-fA-F]{1,4}|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:){0,6}:|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:){0,5}:[0-9a-fA-F]{1,4}|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:){0,4}(:[0-9a-fA-F]{1,4}){1,2}|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:){0,3}(:[0-9a-fA-F]{1,4}){1,3}|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:){0,2}(:[0-9a-fA-F]{1,4}){1,4}|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)([0-9a-fA-F]{1,4}:)?(:[0-9a-fA-F]{1,4}){1,5}|((([0-9a-eA-E]{1,4})|([fF]([0-9a-cA-C]+(0-9a-fA-F){0,2})?)|([fF][eE]([0-79a-bd-fA-BD-F][0-9a-fA-F]?)?)|([fF][fF]([0-9a-bd-fA-BD-F][0-9a-fA-F]?)?)):)((:[0-9a-fA-F]{1,4}){1,6})|:((:[0-9a-fA-F]{1,4}){1,7}|:)|::(ffff(:0{1,4}){0,1}:){0,1}((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]).){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9])|([0-9a-fA-F]{1,4}:){1,4}:((25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]).){3,3}(25[0-5]|(2[0-4]|1{0,1}[0-9]){0,1}[0-9]))\\]|(?:xn--[a-z0-9\\-]{1,59}|(?:(?:[a-z\\u00a1-\\uffff0-9]-*){0,62}[a-z\\u00a1-\\uffff0-9]{1,63}))(?:\\.(?:xn--[a-z0-9\\-]{1,59}|(?:[a-z\\u00a1-\\uffff0-9]-*){0,62}[a-z\\u00a1-\\uffff0-9]{1,63}))*(?:\\.(?:xn--[a-z0-9\\-]{1,59}|(?:[a-z\\u00a1-\\uffff]{2,63})))\\.?)(?::\\d{2,5})?(?:[/?#]\\S*)?$", "i");
